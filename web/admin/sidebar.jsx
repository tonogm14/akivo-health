...
function Sidebar({ admin, dark, toggleDark, onLogout, collapsed, onToggleCollapse, isMobile, onClose }) {
  ...
  ].filter(i => !i.adminOnly || admin.role === 'admin');
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Logo */}
        <div style={{ padding: col?'18px 0':'18px 18px', borderBottom:`1px solid ${T.border}`,
          ...
          {isMobile && (
            <button onClick={onClose} style={{ background:'none', border:'none',
              color:T.inkSoft, cursor:'pointer', padding:4 }}><Ic.X /></button>
          )}
        </div>
